...
parser.add_argument('--model_path', type=str, default='./result/005/prediction_model.093.hdf5')
parser.add_argument('--data_path', type=str, default='./test/')
parser.add_argument('--gpus', type=int, nargs='*', default=[0])
parser.add_argument('--characters', type=str, default = '0123456789' + string.ascii_uppercase + 'a' + 'b'+ '-'  )
...
def gencsv(output_subdir):
    ...
    table.to_excel('./Team046_05.xlsx')
#%%
