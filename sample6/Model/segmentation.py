...
#    plt.imshow(i)
    ...
    circles = cv2.HoughCircles(gray, cv2.HOUGH_GRADIENT, 1.0, gray.shape[0]/50, minRadius = 40, maxRadius = 80, param1=50,param2=30)
...
#            col_name = str( abs( (i % 9) -7  ))
            ...
            img = cv2.resize(img, (135,90))
    #        plt.imshow(img)
            cv2.imwrite(path + row_name + str(col_name)  + '.png', img)
            count +=1
seg()
##%%
#    """
